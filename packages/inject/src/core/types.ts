...
export interface SendOptions {
  ...
  search?: boolean;
  newChat?: boolean;
  /** When true, skip newChat and send directly in the existing conversation context. */
...
export interface SendCallbacks {
  ...
  // conversationId 可能为 undefined：部分站点（元宝/文心）在后台标签页中不更新 URL，
  // 此时以 SSE 首包作为发送成功信号，会话 ID 缺失
