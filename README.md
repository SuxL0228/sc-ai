...
1. 打开 Chrome/Edge 应用商店，搜索「SC 智答」
...
* **🎁 开箱即用（默认）**：默认由 **DeepSeek 网页版**担任智能评审，零成本、零配置，登录 DeepSeek 网页后点开侧边栏直接就能用！
* **🔧 想换别的评审**：在「全局设置」里可以把评审 AI 切换成豆包、通义千问、元宝等任意一个国产 AI，网页版免费模式与 API 模式都支持，丰俭由人。
